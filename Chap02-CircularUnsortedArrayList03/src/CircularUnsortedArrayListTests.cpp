...
TEST(CircularUnsortedArrayList_Dynamic_Duplicate_V2, listEmptyInitializationTest)
{
...
TEST(CircularUnsortedArrayList_Dynamic_Duplicate_V2, PushAndPopBackTest)
{
	CircularUnsortedArrayList list;
	list.pushBack(3);
	list.pushBack(5);
...
TEST(CircularUnsortedArrayList_Dynamic_Duplicate_V2, PushAndPopFrontTest)
{
	CircularUnsortedArrayList list;
	list.pushFront(3);
	list.pushFront(5);
...
TEST(CircularUnsortedArrayList_Dynamic_Duplicate_V2, CircularTest)
{
...
TEST(CircularUnsortedArrayList_Dynamic_Duplicate_V2, listInitializationTest)
{
...
TEST(CircularUnsortedArrayList_Dynamic_Duplicate_V2, findTest){
...
TEST(CircularUnsortedArrayList_Dynamic_Duplicate_V2, iteratorTest){
	CircularUnsortedArrayList list{1,1,1,1,6,7,8,9,10};
	ASSERT_EQ(list.popFront(),1);
	ASSERT_EQ(list.popFront(),1);
	ASSERT_EQ(list.popFront(),1);
	ASSERT_EQ(list.popFront(),1);
	...
	ASSERT_EQ(output,"6,7,8,9,10,3,3,3,3,");
}

TEST(CircularUnsortedArrayList_Dynamic_Duplicate_V2, removeFirstTest){
	CircularUnsortedArrayList list{1,6,3,3,3,6,6,1,7};
	list.removeFirst(6); // 중간 요소 제거
	ASSERT_EQ(list.getSize(),8);
	std::string output = "";
	for(auto i: list)
		output += std::to_string(i)+",";
	ASSERT_EQ(output,"1,3,3,3,6,6,1,7,");
	list.removeFirst(1); // 맨 앞 요소 제거
	ASSERT_EQ(list.getSize(),7);
	output = "";
	for(auto i: list)
		output += std::to_string(i)+",";
	ASSERT_EQ(output,"3,3,3,6,6,1,7,");
	list.removeFirst(7);
	ASSERT_EQ(list.getSize(),6);
	output = "";
	for(auto i: list)
		output += std::to_string(i)+",";
	ASSERT_EQ(output,"3,3,3,6,6,1,");
	list.removeFirst(3);
	list.removeFirst(6);
	list.removeFirst(3);
	list.removeFirst(6);
...
TEST(CircularUnsortedArrayList_Dynamic_Duplicate_V2, removeAllTest){
	CircularUnsortedArrayList list{1,3,1,1,3,4,5,4,6};
	list.removeAll(3);
	ASSERT_EQ(list.getSize(),7);
	std::string output = "";
	for(auto i: list)
		output += std::to_string(i)+",";
	ASSERT_EQ(output,"1,1,1,4,5,4,6,");
	list.removeAll(1);
	ASSERT_EQ(list.getSize(),4);
	output = "";
	for(auto i: list)
		output += std::to_string(i)+",";
	ASSERT_EQ(output,"4,5,4,6,");
	list.removeFirst(5);
...
TEST(CircularUnsortedArrayList_Dynamic_Duplicate_V2, IndexOperator){
	CircularUnsortedArrayList list{10,10,10,10,0,1,2,3,4};
	list.removeAll(10);
	list.pushBack(5);
	list.pushBack(6);
	list.pushBack(7);
	...
	for(auto i: list)
		output += std::to_string(i)+",";
	ASSERT_EQ(output,"11,1,2,3,4,5,6,7,10,");
}

TEST(CircularUnsortedArrayList_Dynamic_Duplicate_V2, clearTest){
	CircularUnsortedArrayList list{1,6,3,3,3,6,6,1,6};
...
TEST(CircularUnsortedArrayList_Dynamic_Duplicate_V2, Big5)
{
