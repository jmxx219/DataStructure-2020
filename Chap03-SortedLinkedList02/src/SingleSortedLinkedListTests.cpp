...
TEST(SingleSortedLinkedList_Duplicate_Tail, listEmptyInitializationTest)
{
...
TEST(SingleSortedLinkedList_Duplicate_Tail, add_popFrontTest)
{
	SingleSortedLinkedList list;
	list.add(3);
	list.add(5);
...
TEST(SingleSortedLinkedList_Duplicate_Tail, add_popBackTest)
{
	SingleSortedLinkedList list;
	list.add(3);
	list.add(5);
...
TEST(SingleSortedLinkedList_Duplicate_Tail, listInitializationTest)
{
...
TEST(SingleSortedLinkedList_Duplicate_Tail, findTest){
...
TEST(SingleSortedLinkedList_Duplicate_Tail, removeFirstTest){
...
TEST(SingleSortedLinkedList_Duplicate_Tail, removeAllTest){
...
TEST(SingleSortedLinkedList_Duplicate_Tail, iteratorTest){
	SingleSortedLinkedList list;
	list.add(3);
	list.add(5);
	list.add(7);
...
TEST(SingleSortedLinkedList_Duplicate_Tail, IndexOperator){
	SingleSortedLinkedList list;
	list.add(3);
	list.add(5);
	ASSERT_EQ(list[0], 3);
...
TEST(SingleSortedLinkedList_Duplicate_Tail, Big5)
{
