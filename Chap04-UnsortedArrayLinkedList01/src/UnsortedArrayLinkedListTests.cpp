...
TEST(UnsortedArrayLinkedList_WithDuplicate_NoTail, listEmptyInitializationTest)
{
...
TEST(UnsortedArrayLinkedList_WithDuplicate_NoTail, PushAndPopFrontTest)
{
	UnsortedArrayLinkedList list;
	list.pushFront(3);
	list.pushFront(5);
...
TEST(UnsortedArrayLinkedList_WithDuplicate_NoTail, PushAndPopBackTest)
{
	UnsortedArrayLinkedList list;
	list.pushBack(3);
	list.pushBack(5);
...
TEST(UnsortedArrayLinkedList_WithDuplicate_NoTail, listInitializationTest)
{
...
TEST(UnsortedArrayLinkedList_WithDuplicate_NoTail, findTest){
...
TEST(UnsortedArrayLinkedList_WithDuplicate_NoTail, removeFirstTest){
	UnsortedArrayLinkedList list;
	list.pushFront(11);
	list.pushFront(7);
	list.pushFront(5);
...
TEST(UnsortedArrayLinkedList_WithDuplicate_NoTail, removeAllTest){
...
TEST(UnsortedArrayLinkedList_WithDuplicate_NoTail, iteratorTest){
	UnsortedArrayLinkedList list;
	list.pushFront(3);
	list.pushFront(5);
	list.pushFront(7);
...
TEST(UnsortedArrayLinkedList_WithDuplicate_NoTail, IndexOperator){
	UnsortedArrayLinkedList list;
	list.pushFront(3);
	list.pushFront(5);
	ASSERT_EQ(list[1], 3);
...
TEST(UnsortedArrayLinkedList_WithDuplicate_NoTail, Big5)
{
