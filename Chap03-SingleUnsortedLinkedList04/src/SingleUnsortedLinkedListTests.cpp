...
TEST(SingleUnsortedLinkedList_WithDuplicate_WithTail, listEmptyInitializationTest)
{
...
TEST(SingleUnsortedLinkedList_WithDuplicate_WithTail, PushAndPopFrontTest)
{
	SingleUnsortedLinkedList list;
	list.pushFront(3);
	list.pushFront(5);
...
TEST(SingleUnsortedLinkedList_WithDuplicate_WithTail, PushAndPopBackTest)
{
	SingleUnsortedLinkedList list;
	list.pushBack(3);
	list.pushBack(5);
...
TEST(SingleUnsortedLinkedList_WithDuplicate_WithTail, listInitializationTest)
{
...
TEST(SingleUnsortedLinkedList_WithDuplicate_WithTail, findTest){
...
TEST(SingleUnsortedLinkedList_WithDuplicate_WithTail, removeFirstTest){
	SingleUnsortedLinkedList list;
	list.pushFront(11);
	list.pushFront(7);
	list.pushFront(5);
...
TEST(SingleUnsortedLinkedList_WithDuplicate_WithTail, removeAllTest){
...
TEST(SingleUnsortedLinkedList_WithDuplicate_WithTail, iteratorTest){
	SingleUnsortedLinkedList list;
	list.pushFront(3);
	list.pushFront(5);
	list.pushFront(7);
...
TEST(SingleUnsortedLinkedList_WithDuplicate_WithTail, IndexOperator){
	SingleUnsortedLinkedList list;
	list.pushFront(3);
	list.pushFront(5);
	ASSERT_EQ(list[1], 3);
...
TEST(SingleUnsortedLinkedList_WithDuplicate_WithTail, Big5)
{
