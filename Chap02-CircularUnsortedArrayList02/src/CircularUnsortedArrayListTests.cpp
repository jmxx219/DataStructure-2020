...
TEST(CircularUnsortedArrayList_Duplicate_V2, listEmptyInitializationTest)
{
...
TEST(CircularUnsortedArrayList_Duplicate_V2, PushAndPopBackTest)
{
	CircularUnsortedArrayList list;
	list.pushBack(3);
	list.pushBack(5);
...
TEST(CircularUnsortedArrayList_Duplicate_V2, PushAndPopFrontTest)
{
	CircularUnsortedArrayList list;
	list.pushFront(3);
	list.pushFront(5);
...
TEST(CircularUnsortedArrayList_Duplicate_V2, CircularTest)
{
	...
	while(!list.isEmpty())
		output += std::to_string(list.popFront())+",";
	ASSERT_EQ(output,"3,4,5,6,7,8,9,11,12,");
}

TEST(CircularUnsortedArrayList_Duplicate_V2, listInitializationTest)
{
...
TEST(CircularUnsortedArrayList_Duplicate_V2, findTest){
...
TEST(CircularUnsortedArrayList_Duplicate_V2, iteratorTest){
...
TEST(CircularUnsortedArrayList_Duplicate_V2, removeFirstTest){
...
TEST(CircularUnsortedArrayList_Duplicate_V2, removeAllTest){
...
TEST(CircularUnsortedArrayList_Duplicate_V2, IndexOperator){
...
TEST(CircularUnsortedArrayList_Duplicate_V2, clearTest){
...
TEST(CircularUnsortedArrayList_Duplicate_V2, Big5)
{
