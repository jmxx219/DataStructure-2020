...
TEST(SingleUnsortedLinkedList_WithDuplicate_NoTailV1, listEmptyInitializationTest)
{
...
TEST(SingleUnsortedLinkedList_WithDuplicate_NoTailV1, PushAndPopFrontTest)
{
	SingleUnsortedLinkedList list;
	list.pushFront(3);
	list.pushFront(5);
...
TEST(SingleUnsortedLinkedList_WithDuplicate_NoTailV1, PushAndPopBackTest)
{
	SingleUnsortedLinkedList list;
	list.pushBack(3);
	list.pushBack(5);
...
TEST(SingleUnsortedLinkedList_WithDuplicate_NoTailV1, listInitializationTest)
{
...
TEST(SingleUnsortedLinkedList_WithDuplicate_NoTailV1, findTest){
...
TEST(SingleUnsortedLinkedList_WithDuplicate_NoTailV1, removeFirstTest){
	SingleUnsortedLinkedList list;
	list.pushFront(11);
	list.pushFront(7);
	list.pushFront(5);
...
TEST(SingleUnsortedLinkedList_WithDuplicate_NoTailV1, removeAllTest){
...
TEST(SingleUnsortedLinkedList_WithDuplicate_NoTailV1, iteratorTest){
	SingleUnsortedLinkedList list;
	list.pushFront(3);
	list.pushFront(5);
	list.pushFront(7);
...
TEST(SingleUnsortedLinkedList_WithDuplicate_NoTailV1, IndexOperator){
	SingleUnsortedLinkedList list;
	list.pushFront(3);
	list.pushFront(5);
	ASSERT_EQ(list[1], 3);
...
TEST(SingleUnsortedLinkedList_WithDuplicate_NoTailV1, Big5)
{
